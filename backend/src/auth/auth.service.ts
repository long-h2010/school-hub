...
export class AuthService {
    ...
    async register(registerDto: RegisterDto) {
        ...
        if (existingUser) throw new UnauthorizedException('Student ID already exists');
    ...
    async googleLogin(payload: any) {
        ...
        if (verify != process.env.VERIFY_EMAIL) throw new UnauthorizedException('Email is not accepted');
