...
import { ChatDisplay, Conversation, CreateGroupModal, DefaultDisplay } from '../components/chat';
...
const Messenger: React.FC = () => {
    ...
    const handleSelectChat = useCallback(
        (chat: Chat) => {
            ...
            AxiosClient.put(`${import.meta.env.VITE_APP_MESSAGE_MASK_READED_ENDPOINT}/${chat.id}`);
    ...
    return (
        <div className='flex h-screen pt-14 bg-gradient-to-br from-gray-50 to-gray-100'>
            ...
            {showCreateGroup && (
                <CreateGroupModal users={chats} setShowCreateGroup={setShowCreateGroup} />
            )}
        </div>
    );
};
