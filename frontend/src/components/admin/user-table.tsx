                ...
                <tbody className='divide-y divide-gray-100'>
                    {users.map((user) => (
                        ...
                        >
                            ...
                            <td className='py-4 px-6 text-gray-600 font-medium'>{user.email || `${user.studentId}@dtu.com`}</td>
                            <td className='py-4 px-6'>
                                {user.status === 'active' && (
                            ...
                            <td className='py-4 px-6'>
                                <span className='text-gray-900 font-bold'>{user.posts ?? 0}</span>
                            </td>
                            <td className='py-4 px-6'>
                                <span className='text-gray-900 font-bold'>{user.comments ?? 0}</span>
                            </td>
                            <td className='py-4 px-6'>
